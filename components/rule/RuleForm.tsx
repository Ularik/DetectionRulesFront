      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-start">
          <div className="space-y-1">
            ...
            <Input
              {...register("match_type", {
                required: "Введите тип совпадения",
              })}
        ...
        <div className="flex gap-3 pt-2">
          ...
          <button
            type="submit"
            disabled={isPending}
            className="flex-[2] flex items-center justify-center rounded-2xl bg-[#1E2B6D] px-4 py-3 font-semibold text-white transition hover:bg-[#162356] disabled:opacity-50 h-12"
          >
            {isPending ? (
